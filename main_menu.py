...
def main_menu():
    start_button = ImageButton(WIDTH / 2 - (252 / 2), 250, 252, 74, 'Новая игра', 'button1.jpg', 'button2.jpg',
                               'click2.mp3')
    audio_button = ImageButton(WIDTH / 2 - (252 / 2), 400, 252, 74, 'Аудио', 'button1.jpg', 'button2.jpg',
                               'click2.mp3')
    exit_button = ImageButton(WIDTH / 2 - (252 / 2), 550, 252, 74, 'Выход', 'button1.jpg', 'button2.jpg', 'click2.mp3')
    logos = ['gray_logo.png', 'blue_logo.png', 'white_logo.png']
    ind_logo = 0
    running = True
    while running:
        screen.fill((0, 0, 0))
        ...
        logo = load_image(logos[ind_logo])
        logo = pygame.transform.scale(logo, (350, 170))
        rect = logo.get_rect()
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                x, y = event.pos
                if pygame.Rect(325, 65, 350, 170).collidepoint(x, y):
                    ind_logo += 1
                    if ind_logo == 3:
                        ind_logo = 0
...
def new_game():
    back_button = ImageButton(0, 0, 150, 50, 'Назад', 'button1.jpg', 'button2.jpg', 'click2.mp3')
    ready = ImageButton(WIDTH / 2 - (252 / 2), 400, 252, 74, 'Начать!', 'button1.jpg', 'button2.jpg', 'click2.mp3')
    name = ''
    need_input = False
    running = True
    while running:
...
def start_text():
    ...
    y = 0
    with open("Data/Texts/vved.txt", encoding="utf8") as f:
        lines = f.readlines()
...
def audio():
    song_yes = load_image('sound_yes.png')
    song_yes = pygame.transform.scale(song_yes, (80, 80))
    song_no = load_image('sound_no.png')
